    ...
    <div className="min-h-screen bg-cream flex flex-col">
      ...
      <nav className="flex items-center justify-between px-12 py-[18px] border-b border-border">
        ...
        <div className="flex items-center gap-3 text-[13px]">
          <span className="text-ink3">Are you a partner?</span>
          <Link href="/partner/sign-in" className="font-semibold text-ink hover:opacity-70 no-underline">
            Partner sign-in →
          </Link>
        </div>
      </nav>
      ...
      <div className="flex flex-1 items-center justify-center py-16 px-8">
        <div className="w-full max-w-[400px]">
          <div className="text-center mb-8">
            <div className="text-[11px] font-semibold tracking-[0.1em] uppercase text-gold mb-2">Event planners</div>
            <h1 className="font-display text-3xl font-bold text-ink mb-2">Find your perfect supplier</h1>
            <p className="text-[13px] text-ink2">Sign in to browse, save, and contact event suppliers across Canada.</p>
          </div>
